                            ...
                            for (int i = 0; i < likeDataArrayList.size(); i++) {
                                ...
                                if (likeDataArrayList.get(i).getGetID().equals(contents.get(position).getId()) &&
                                    ...
                                    if (!likeDataArrayList.get(i).getSetID().equals(userID)) {
                                        Log.d("QE", "빈하트");
                                        holder.likeButton.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.unlike, 0);
//                                        holder.likeButton.setText(likecount + "2");
                                        Log.d("QWE", likecount+"");

                                    } else {
                                        Log.d("QE", "하트");
                                        holder.likeButton.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.like, 0);
//                                        holder.likeButton.setText(likecount + "1");
                                        Log.d("QWE", likecount+"");
                                    }
                                    Log.d("QW", likecount + "");
...
//                                                holder.frameLayout.setVisibility(View.GONE);
                ...
                Log.d("QW", "######");
                if(contents.get(position).getAnonymous()==0) {
                    ...
                    for (int i = 0; i < userList.size(); i++) {
                        if (contents.get(position).getId().equals(userList.get(i).getUserID())) {
                            if (!userList.get(i).getUserImage().equals("")) {
                                Picasso.get().load(userList.get(i).getUserImage().toString()).into(holder.snsCircle);
                            } else {
                                holder.snsCircle.setImageDrawable(context.getResources().getDrawable(R.drawable.proimage));
                            }
                            //holder.snsImage.setVisibility(View.VISIBLE);
                        } else {
//                        holder.snsImage.setVisibility(View.GONE);
...
//                 holder.likeButton.setText(likeDataArrayList.size());
                ...
                holder.datButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        n = itemposition;
                        Log.d("TTTT", likeDataArrayList.size()+"");
                        for(int j=0; j<likeDataArrayList.size(); j++){
                            if(contents.get(n).getTitle().equals(likeDataArrayList.get(j).getGetTitle())&&
                                    contents.get(n).getDate().equals(likeDataArrayList.get(j).getGetDate())&&
                                    contents.get(n).getId().equals(likeDataArrayList.get(j).getGetID())){
                                likecount++;
                                Log.d("TTTT", likecount+"");
                            }
                        }
...
//        notifyDataSetChanged();
    ...
    public void setDataLikeDB(ArrayList<LikeData> contents) {
       ...
       this.likeDataArrayList=contents;
//        notifyDataSetChanged();
    }

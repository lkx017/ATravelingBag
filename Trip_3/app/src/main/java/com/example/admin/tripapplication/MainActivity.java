        ...
        public Fragment getItem(int position) {
            switch (position % 3) {
                ...
                case 2:
                    ...
                    name = intent2.getStringExtra("inputID");
                    Log.d("QW", snsDataArrayList.size() + "");
                    userList2=(ArrayList<User>)intent2.getSerializableExtra("users");
                    bundle2.putString("id", name);
                    bundle2.putSerializable("users", userList2);
                    bleFragment.setArguments(bundle2);
                    return bleFragment;
                default:
                    return null;
            }
...
//        mViewPager.notifyHeaderChanged();
    ...
    public void discon_notification(int p, int icon , String name , String item){
        NotificationCompat.Builder nb2;
        nb2 = new NotificationCompat.Builder(this);
        Bitmap largeIconForNoti2 =
                BitmapFactory.decodeResource(getResources(),icon);
        nb2.setSmallIcon(icon)
                .setContentText(name+" ("+item+") "+"연결이 끊어졌습니다.")
                .setDefaults(Notification.DEFAULT_SOUND)
                .setLargeIcon(largeIconForNoti2)
                .setPriority(NotificationCompat.PRIORITY_MAX)
                .setAutoCancel(true)
                .setVisibility(Notification.VISIBILITY_PUBLIC);
        NotificationManager nm2 = (NotificationManager)getSystemService(NOTIFICATION_SERVICE);
        nm2.notify(p+10,nb2.build());

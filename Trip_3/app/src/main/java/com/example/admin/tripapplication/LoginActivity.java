...
import com.example.admin.tripapplication.sns.ProgressBarCircular;
...
//        progressBarCircular.setVisibility(View.INVISIBLE);
        ...
        progressBarCircular=findViewById(R.id.progress);
        /*LoadingTask loadingTask=new LoadingTask();
        loadingTask.execute();*/
        progressBarCircular.setBackgroundColor(getResources().getColor(R.color.loding));
...
//                                snsinitDatabase();
                        ...
                        for (int i = 0; i < userList.size(); i++) {
                            if (userList.get(i).getUserID().equals(inputID) &&
                                    userList.get(i).getUserPassword().equals(inputPW)) {
                                user = userList.get(i);

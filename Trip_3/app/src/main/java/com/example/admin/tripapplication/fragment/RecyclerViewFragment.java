            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if(snsDataArrayList.size()>0) {
                    for (int i = snsDataArrayList.size() - 1; i >= snsDataArrayList.size() - 1; i--) {
                        temp.add(new SnsData(snsDataArrayList.get(i).getId(), snsDataArrayList.get(i).getDate(), snsDataArrayList.get(i).getTitle(), snsDataArrayList.get(i).getText(), snsDataArrayList.get(i).getImageurl(),snsDataArrayList.get(i).getAnonymous()));
...
//                Log.d("QE", snsDataArrayList.size() + "");
                ...
                if(likeDataArrayList.size()>0) {
                    for (int i = likeDataArrayList.size() - 1; i >= likeDataArrayList.size() - 1; i--) {
                        templike.add(new LikeData(likeDataArrayList.get(i).getGetID(), likeDataArrayList.get(i).getGetTitle(), likeDataArrayList.get(i).getGetDate(), likeDataArrayList.get(i).getSetID(), likeDataArrayList.get(i).getSetText()));
                    }

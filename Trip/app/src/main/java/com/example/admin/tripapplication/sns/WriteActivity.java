...
//                    setLikeData(userID, titleEdit.getText().toString(), formatDate, "", "");
                    ...
                    setSnsDB(userID, formatDate, titleEdit.getText().toString(), textEdit.getText().toString(), "");
//                    setLikeData(userID, titleEdit.getText().toString(), formatDate, "", "");
                }
                else {
    ...
    public void setSnsDB(String id, String date, String title, String text, String image) {
        snsData = new SnsData(id, date, title, text, image);
...
//                            textView.setText(sb.toString());
                            ...
                            Log.d("EEE", path);
                            setSnsDB(userID, formatDate, titleEdit.getText().toString(), textEdit.getText().toString(), path);
                        }
                    });
                } catch (Exception e) {
                    e.printStackTrace();
